...
stock_symbols = ['JSWSTEEL.NS','CIPLA.NS','LT.NS','NESTLEIND.NS','TITAN.NS','TATAMOTORS.NS']

if selected_page == "Chart":
    # Select product (Forex, CFD, or Crypto)
    product = st.sidebar.selectbox("Select Financial Instrument", ['JSWSTEEL.NS','CIPLA.NS','LT.NS','NESTLEIND.NS','TITAN.NS','TATAMOTORS.NS'])
